...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $asus = Product::factory()->create([
            'name' => 'ASUS ROG Strix G15',
            'slug' => 'asus-rog-strix-g15',
            'price' => 999,
            'image' => '/images/products/asus-rog-strix-g15.jpg',
            'category_id' => 3,
            'brand_id' => 6,
            'color_id' => 1,
            'size_id' => 2,
        ...
        // rating between 3 and 5
        $asus->reviews()->createMany(
            Review::factory()->count(10)->make([
                'rating' => random_int(3, 5),
            ])->toArray()
        );

        $lenovo = Product::factory()->create([
        ...
        // rating between 3 and 5
        $lenovo->reviews()->createMany(
            Review::factory()->count(10)->make([
                'rating' => random_int(3, 5),
            ])->toArray()
        );

        $google = Product::factory()->create([
            'name' => 'Google Pixel 6',
            'slug' => 'google-pixel-6',
            'price' => 499,
        ...
        // rating between 2 and 4
        $google->reviews()->createMany(
            Review::factory()->count(10)->make([
                'rating' => random_int(2, 4),
            ])->toArray()
        );

        $dell = Product::factory()->create([
            'name' => 'Dell XPS 13',
            'slug' => 'dell-xps-13',
            'price' => 999,
